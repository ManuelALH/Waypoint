...
self.addEventListener('fetch', event => {
    ...
    // Network Only para el resto
    // Peticiones a la API de Django, autenticacion, etc. Siempre necesitan red
    // Si falla, simplemente falla. No mostramos datos viejos de operaciones criticas
});
